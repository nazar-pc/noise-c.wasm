...
gulp
	...
	.task('wasm', (callback) !->
		files		= [
			...
			'vendor/src/protocol/../backend/ref/dh-curve448.c'
			'vendor/src/protocol/../backend/ref/dh-newhope.c'
			'vendor/src/protocol/../backend/ref/hash-blake2s.c'
			'vendor/src/protocol/../crypto/blake2/blake2s.c'
			'vendor/src/protocol/../crypto/curve448/curve448.c'
			'vendor/src/protocol/../crypto/goldilocks/src/p448/arch_32/p448.c'
			'vendor/src/protocol/../crypto/newhope/batcher.c'
			'vendor/src/protocol/../crypto/newhope/error_correction.c'
			'vendor/src/protocol/../crypto/newhope/fips202.c'
			'vendor/src/protocol/../crypto/newhope/newhope.c'
			'vendor/src/protocol/../crypto/newhope/ntt.c'
			'vendor/src/protocol/../crypto/newhope/poly.c'
			...
			'vendor/src/protocol/../backend/ref/hash-blake2b.c'
			'vendor/src/protocol/../backend/ref/hash-sha256.c'
			'vendor/src/protocol/../backend/ref/hash-sha512.c'
			'vendor/src/protocol/../backend/ref/sign-ed25519.c'
			'vendor/src/protocol/../crypto/aes/rijndael-alg-fst.c'
			'vendor/src/protocol/../crypto/blake2/blake2b.c'
			'vendor/src/protocol/../crypto/chacha/chacha.c'
			'vendor/src/protocol/../crypto/donna/poly1305-donna.c'
			'vendor/src/protocol/../crypto/ghash/ghash.c'
			'vendor/src/protocol/../crypto/newhope/crypto_stream_chacha20.c'
			'vendor/src/protocol/../crypto/sha2/sha256.c'
			'vendor/src/protocol/../crypto/sha2/sha512.c'
			'vendor/src/protocol/../crypto/ed25519/ed25519.c'
		].join(' ')
		/**
