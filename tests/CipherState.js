...
(function(){
  ...
  test = require('tape');
  lib.ready(function(){
    var key, i$, ref$, len$, cipher, j$, ref1$, len1$, plaintext, k$, ref2$, len2$, ad;
    key = randombytes(32);
    ...
    test('CipherState (NOISE_CIPHER_CHACHAPOLY): Check for encryption correctness', function(t){
      var ad, key, known_plaintext, known_ciphertext, cs1, ciphertext, cs2, plaintext;
      ad = new Uint8Array;
