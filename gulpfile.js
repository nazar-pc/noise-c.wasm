...
(function(){
  ...
  gulp.task('build', ['clean', 'wasm', 'browserify', 'minify'], function(){
    ...
    optimize = "-O2 -s NO_EXIT_RUNTIME=1 -s NO_FILESYSTEM=1";
    ...
    command = "EMMAKEN_CFLAGS='" + clang_opts + "' emcc " + files + " src/noise-c.c --post-js src/bytes_allocation.js --post-js src/library_ed25519_random_and_hash.js -o noise-c.js -s MODULARIZE=1 -s EXPORTED_FUNCTIONS='" + functions + "' -s WASM=1 " + optimize;
